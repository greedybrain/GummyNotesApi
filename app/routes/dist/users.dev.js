  ...
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap(getUsers(req, res));
...
userRouter.post('/', function _callee3(req, res) {
...
userRouter.get('/:id/notes', ifAuthorized, function _callee4(req, res) {
...
userRouter.post('/:id/notes', ifAuthorized, function _callee5(req, res) {
...
userRouter.patch('/:user_id/notes/:note_id', ifAuthorized, function _callee6(req, res) {
...
userRouter["delete"]('/:user_id/notes/:note_id', ifAuthorized, function _callee7(req, res) {
